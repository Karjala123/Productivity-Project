...
class AiSuggestionsScreen extends StatelessWidget {
  ...
  IconData _categoryIcon(String category) {
    switch (category) {
      ...
      case 'break': return Icons.coffee_outlined;
      case 'schedule': return Icons.schedule_outlined;
      case 'app_usage': return Icons.phone_android_outlined;
  ...
  Color _categoryColor(String category) {
    switch (category) {
      ...
      case 'break': return AppColors.accent;
      case 'schedule': return AppColors.info;
      case 'app_usage': return AppColors.warning;
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      const Text('AI Productivity Coach',
                          style: TextStyle(
                              color: Colors.white,
